...
const Checkout: React.FC = () => {
    ...
    const [, setMerchantOid] = useState<string | null>(null);
    ...
    const initializePayTR = async () => {
        ...
        try {
            ...
            const { data } = await api.post<PayTRPaymentResponse>('/payment/create-payment', {
            ...
            if (axios.isAxiosError(err)) {
                ...
                setPaytrError('Ödeme başlatılırken bir hata oluştu.');
            }
        } finally {
    ...
    // Note: handlePlaceOrder is used by PayTR payment flow in the future
    // For now, the order placement is handled within initiatePayTRPayment
