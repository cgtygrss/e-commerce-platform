import React, { useEffect, useState, useMemo, ChangeEvent, KeyboardEvent } from 'react';
...
const Shop: React.FC = () => {
    ...
    const { availableColors, availableMaterials, minPrice, maxPrice } = useMemo(() => {
        const colors = [...new Set(products.map(p => p.color).filter((c): c is string => Boolean(c)))];
                            ...
                            <div className="filter-section">
                                ...
                                <div className="price-sliders">
                                    <input
                                        ...
                                        max={maxPrice}
                                        value={priceRange[0]}
                                        onChange={(e: ChangeEvent<HTMLInputElement>) => setPriceRange([Math.min(Number(e.target.value), priceRange[1] - 10), priceRange[1]])}
                                    />
                                    <input
                                        type="range"
                                        className="price-slider"
                                        ...
                                        max={maxPrice}
                                        value={priceRange[1]}
                                        onChange={(e: ChangeEvent<HTMLInputElement>) => setPriceRange([priceRange[0], Math.max(Number(e.target.value), priceRange[0] + 10)])}
                                    />
                                </div>
                            </div>
                            ...
                            <div className="filter-section">
                                ...
                                <label className="toggle-switch">
                                    <input
                                        type="checkbox"
                                        checked={inStockOnly}
                                        onChange={(e: ChangeEvent<HTMLInputElement>) => setInStockOnly(e.target.checked)}
                                    />
